...
An example of generic system used in robotics for situation assessment is \cite{beetz2015robosherlock}
...
\cite{scheutz2013computational}) presents a situation assessment system able to model different agent's beliefs. The work is oriented in particular toward communication problems and not geometrical and spatial perspective taking issues.
