...
\lhead{Chapter 14. \emph{Conclusion}} % Change X to a consecutive number; this is for the header on each page - perhaps a shortened title
...
% to\item The robot has simple mechanisms for dialogue. It is able to receive goals from a tablet application, and it has been interfaced with a text to speech system.
